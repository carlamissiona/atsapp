...
public class GmailApiPlugin {
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File(
			...
			".credentials/gmail-java-GmailApiPlugin");
	...
	/**
	 * Global instance of the scopes required by this GmailApiPlugin.
	 * 
	...
	public static Credential authorize() throws IOException {
		// Load client secrets.
		InputStream in = GmailApiPlugin.class
	...
	public static String send() throws IOException {
		...
		return "No of Labesl" + labels.size();
	}
