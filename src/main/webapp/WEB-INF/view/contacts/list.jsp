...
<body>
	...
	<script type="application/javascript">
        ...
        $(document).ready(function () {
			...
			for (i = 0; i < contactsStore.length; i++) { 
				$(".table-candidates tbody").append(
				  "<tr> <td> <div class='checkbox'> <label> <input type='checkbox' value='"+  contactsStore[i].ca_email  +"'> </label> </div> </td>" +
				  " <td>" + contactsStore[i].co_firstname + " " + contactsStore[i].co_lastname + " </td>" +
				  " <td>" + contactsStore[i].co_email +"</td> " +
				  " <td>" + contactsStore[i].co_add + "</td>" +
				  " <td>" + contactsStore[i].co_tel + "</td>" +
				  " <td>" + contactsStore[i].co_mobile + "</td>" + 
				  " <td>  <div class='btn-group open action-drop'> " +
				      "<button type='button' class='btn btn-theme03'>Action</button> " + 
				       ...
				       "<ul class='dropdown-menu' role='menu'>" +
				         "<li><a href='/candidates/view/"+ contactsStore[i].cm_id +"'>View</a></li>" +
